...
const dependencyAnalyzerTool = tool({
    description: "Analyze project dependencies for outdated packages, security vulnerabilities, and unused dependencies. Supports npm, pnpm, yarn, and bun.",
    args: {
        type: tool.schema
...
async function analyzeDependencies(cwd, packageManager, depth) {
    const dependencies = [];
    try {
        // Read package.json
...
function generateRecommendations(dependencies, summary, analysisType) {
